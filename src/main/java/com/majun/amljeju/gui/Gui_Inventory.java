...
public class Gui_Inventory extends GuiContainer {
    private float oldMouseX;

    private float oldMouseY;

    public Gui_Inventory(EntityPlayer player, InventoryPlayer inventoryPlayer) {
        super(new Container_Inventory(inventoryPlayer, player));
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        DrawManager.drawCenteredString(Data.Player_Name,width * 0.3738F, height * 0.6018F, width * 0.0030F, new Color(0, 0, 0), false);
        DrawManager.drawCenteredString(Data.Job,width * 0.3738F, height * 0.6787F, width * 0.0030F, new Color(0, 0, 0), false);
    }
